 ...
 *
 * On a phone the strip slides sideways rather than wrapping: nine labels
 ...
 * `SlideRow` fades the edge that hides tabs and brings the active one into
 * view after a tap near the right end.
 */
